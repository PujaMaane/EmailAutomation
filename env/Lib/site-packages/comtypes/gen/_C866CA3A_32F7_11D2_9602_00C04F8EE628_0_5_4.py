...
__all__ = [
    'SpeechTokenKeyAttributes', 'SPEI_UNDEFINED',
    'DISPID_SpeechBaseStream', 'SpeechBookmarkOptions',
    'SAFTNonStandardFormat', 'SVP_8', 'DISPID_SAFType',
    'Speech_StreamPos_Asap', 'DISPID_SRGetPropertyNumber',
    'SPGS_DISABLED', 'ISpeechMemoryStream',
    'DISPID_SpeechGrammarRule', 'DISPID_SDKGetBinaryValue',
    'DISPID_SRSSupportedLanguages', 'SREStateChange', 'DISPID_SVSkip',
    'SPPS_LMA', 'SPDKL_CurrentConfig', 'DISPID_SDKCreateKey',
    'eLEXTYPE_PRIVATE12', 'SAFTNoAssignedFormat', 'SpStream',
    'ISpDataKey', 'DISPID_SpeechRecoResultTimes',
    'ISpeechAudioStatus', 'SVP_19', 'DISPID_SPAs_NewEnum',
    'SpUnCompressedLexicon', 'SECFIgnoreCase',
    'DISPID_SWFESamplesPerSec', 'DISPID_SOTSetId', 'SPAR_Low',
    'DISPID_SVGetAudioInputs', 'SGLexical', 'SAFTADPCM_11kHzMono',
    'DISPID_SRCESoundEnd', 'DISPID_SRGSetTextSelection',
    'SPVPRI_ALERT', 'ISpeechDataKey', 'SAFTCCITT_ALaw_44kHzMono',
    'eLEXTYPE_PRIVATE2', 'DISPID_SMSAMMHandle',
    'SpeechGrammarTagWildcard', 'DISPID_SRGCommit', 'SPRST_ACTIVE',
    'SRATopLevel', 'SpeechVoiceCategoryTTSRate', 'SGRSTTEpsilon',
    'ISpeechGrammarRuleStateTransition', 'SPBO_NONE',
    'SpObjectTokenCategory', 'SAFT11kHz16BitMono',
    'SpeechRecoContextState', 'SAFTDefault', 'SPEI_END_INPUT_STREAM',
    ...
    'DISPID_SRGCmdSetRuleState', 'SVSFIsNotXML', 'DISPID_SLGetWords',
    'SRSActive', 'DISPID_SAVolume', 'DISPID_SRGetFormat',
    'ISpRecoGrammar', 'SPBO_PAUSE', 'SpeechWordPronounceable',
    'SPINTERFERENCE_NONE', 'SpeechCategoryAppLexicons',
    'SVF_Emphasis', 'SpeechRecoProfileProperties',
    'DISPID_SVSCurrentStreamNumber', 'SSTTTextBuffer',
    'DISPID_SRCESoundStart', 'SPEI_PHONEME', 'SPEI_PHRASE_START',
    'DISPID_SGRClear', 'STCAll', 'SpeechGrammarTagDictation',
    'DISPID_SPEEngineConfidence', 'SFTSREngine', 'SpMMAudioIn',
    'SPEI_RESERVED6', 'SAFT24kHz8BitMono', 'DISPID_SRCEBookmark',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SVVoice', 'LONG_PTR',
    'DISPID_SLAddPronunciation', 'SDKLDefaultLocation',
    'eLEXTYPE_USER', 'SPAR_Medium', 'SpeechInterference',
    'ISpPhoneticAlphabetConverter', 'DISPID_SWFEFormatTag',
    'STSF_CommonAppData', 'DISPID_SpeechRecoResult', 'ISpRecognizer',
    'SPRST_ACTIVE_ALWAYS', 'SPRS_ACTIVE', 'eWORDTYPE_ADDED',
    'SPPS_RESERVED3', 'SPEI_MAX_SR', 'SAFT48kHz8BitStereo',
    'DISPID_SRCSetAdaptationData', 'DISPID_SWFEBlockAlign',
    'SPWT_PRONUNCIATION', 'SAFT11kHz8BitMono', 'SWTAdded',
    'eLEXTYPE_PRIVATE20', 'SAFT22kHz8BitStereo',
    'DISPID_SRIsUISupported', 'SREFalseRecognition',
    'DISPID_SPIGetText', 'STCLocalServer', 'DISPID_SLPs_NewEnum',
    'DISPID_SADefaultFormat', 'SpWaveFormatEx', 'ISpRecognizer2',
    'SPWAVEFORMATTYPE', 'DISPID_SVGetProfiles', 'SVEBookmark',
    'DISPID_SRSetPropertyString', 'SpeechDiscardType',
    'SPEI_END_SR_STREAM', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SPPNumberOfElements', 'DISPID_SASFreeBufferSpace',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SpeechRecoContext',
    'SPPHRASE', '_SPAUDIOSTATE', 'DISPID_SGRAddState',
    'SpSharedRecognizer', 'SPAR_Unknown', 'SPEI_RESERVED2',
    'DISPID_SPEDisplayText', 'ISpeechTextSelectionInformation',
    'SpeechVoicePriority', 'DISPID_SVSInputWordLength',
    'SDTLexicalForm', 'DISPID_SRRGetXMLErrorInfo',
    'SGDSActiveUserDelimited', 'SpeechVisemeType',
    'ISpeechObjectTokenCategory', 'DISPID_SRState', 'SRAExport',
    'SFTInput', 'SPEI_MIN_TTS', 'SVP_6', 'SAFTCCITT_uLaw_44kHzStereo',
    'SDKLCurrentUser', 'DISPID_SPPConfidence', 'SPEI_VISEME',
    'STSF_FlagCreate', 'DISPID_SRCCreateGrammar',
    'SAFTExtendedAudioFormat', 'DISPID_SpeechRecoResult2',
    'DISPID_SLPPartOfSpeech', 'DISPID_SVEStreamEnd',
    'ISpeechLexiconWord', 'SpCompressedLexicon', 'SRAONone',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SVP_9',
    'SP_VISEME_18', 'SVEVoiceChange', 'SpeechEngineConfidence',
    'SPSHT_EMAIL', 'SpeechAudioFormatGUIDText',
    'SPRS_ACTIVE_USER_DELIMITED', 'ISpeechPhraseRules',
    'eLEXTYPE_PRIVATE19', 'SPCT_DICTATION', 'SPVPRI_OVER',
    'DISPID_SRRTTickCount', 'DISPID_SVSLastResult',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SABufferNotifySize',
    'ISpNotifySink', 'DISPID_SRCEInterference',
    'DISPID_SOTGetStorageFileName', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SVRate', 'SAFT24kHz8BitStereo',
    'DISPID_SPRuleNumberOfElements', 'SP_VISEME_12', 'SASClosed',
    'SPPS_Interjection', 'SVEViseme', 'eLEXTYPE_PRIVATE14',
    ...
    'SPFM_CREATE', 'ISpeechMMSysAudio', 'ISpEventSink',
    'DISPID_SRRTLength', 'SPAUDIOSTATUS', 'SPPS_Modifier',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SPIElements',
    'SPSEMANTICFORMAT', 'eLEXTYPE_RESERVED8',
    'DISPID_SPRNumberOfElements', 'DISPID_SPCPhoneToId',
    'SECFIgnoreWidth', 'ISpeechRecognizerStatus', 'DISPID_SGRSTType',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SpeechPhraseElement',
    'IInternetSecurityManager', 'DISPID_SOTsItem', 'SPEI_SR_PRIVATE',
    'SP_VISEME_15', 'SpeechTokenKeyUI', 'DISPID_SBSFormat',
    'DISPID_SPEActualConfidence', 'DISPID_SLGenerationId',
    'SPGRAMMARWORDTYPE', 'DISPID_SOTRemove', 'SpeechGrammarWordType',
    'DISPID_SGRSAddRuleTransition', 'SDTAll', 'DISPID_SRRTimes',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SPRsCount',
    'DISPID_SPCIdToPhone', 'SPCT_COMMAND',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SMSALineId',
    'ISpSerializeState', 'SpeechRegistryLocalMachineRoot',
    'SpLexicon', 'DISPID_SASetState', 'SPEI_INTERFERENCE',
    'DISPID_SRCEPropertyNumberChange', 'SREAllEvents', 'SPSLMA',
    'SPSEMANTICERRORINFO', 'DISPID_SRAudioInput',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SPRsItem', 'SPGRAMMARSTATE',
    'SpeechVoiceSpeakFlags', 'SPLOADOPTIONS', 'SpeechTokenValueCLSID',
    'ISpStream', 'ISpeechPhraseInfoBuilder',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SDTProperty',
    'DISPID_SGRAttributes', 'SREBookmark',
    'DISPID_SpeechXMLRecoResult', 'SRAInterpreter',
    'SPPHRASEREPLACEMENT', 'SRERecoOtherContext',
    'DISPID_SDKSetLongValue', 'SpFileStream', 'SAFTGSM610_22kHzMono',
    'SRCS_Enabled', 'DISPID_SVEventInterests', 'SVSFPersistXML',
    'ISpeechVoice', 'SVP_1', 'DISPID_SGRAddResource',
    'SAFTGSM610_44kHzMono', 'SECLowConfidence', 'SREAdaptation',
    'ISpObjectToken', 'ISpeechPhoneConverter', 'SPLO_STATIC',
    'DISPID_SVESentenceBoundary', 'SPCATEGORYTYPE',
    'SAFT11kHz16BitStereo', 'DISPID_SRCEFalseRecognition',
    'DISPID_SRCEAudioLevel', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SPEAudioSizeTime', 'SVSFNLPSpeakPunc', 'DISPID_SAStatus',
    'SRSInactiveWithPurge', '_RemotableHandle', 'SPPROPERTYINFO',
    'DISPID_SDKSetBinaryValue', 'SAFT32kHz16BitStereo',
    'DISPID_SRGReset', 'SpeechTokenKeyFiles', 'SECFDefault',
    ...
    'SpeechVoiceEvents', 'DISPID_SPRulesCount',
    'tagSPTEXTSELECTIONINFO', 'SLOStatic', 'DISPID_SVAudioOutput',
    'DISPID_SLWsCount', 'SRESoundStart', 'SREAudioLevel',
    'DISPID_SpeechLexiconWords', 'ISpNotifySource', 'SPRS_INACTIVE',
    'SDA_One_Trailing_Space', 'DISPID_SLWWord', 'ISpStreamFormat',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SGRSTPropertyId',
    'DISPID_SAEventHandle', 'SRTEmulated', 'DISPID_SMSADeviceId',
    ...
    'SPEI_RECO_OTHER_CONTEXT', 'SP_VISEME_13', 'ISpRecoContext',
    'DISPID_SpeechAudio', 'SPLO_DYNAMIC', 'SECFIgnoreKanaType',
    'SAFT22kHz16BitMono', 'SpeechAudioFormatType',
    'SDA_Consume_Leading_Spaces', 'ISpeechPhraseAlternates',
    'SREPhraseStart', 'SASStop', 'SLTApp', 'eLEXTYPE_MORPHOLOGY',
    'SAFT48kHz8BitMono', 'SpSharedRecoContext',
    'DISPID_SASNonBlockingIO', 'SVP_20', 'DISPID_SRRRecoContext',
    'SPDKL_CurrentUser', 'SVPNormal', 'SAFT24kHz16BitStereo',
    'ISpeechGrammarRule', 'SPSERIALIZEDRESULT',
    ...
    'DISPID_SPIStartTime', 'SASPause', 'SAFT8kHz8BitMono',
    'SpeechRecoEvents', 'SpeechPartOfSpeech', 'SAFT12kHz8BitStereo',
    'ISpeechPhraseInfo', 'SpVoice', 'SPEI_TTS_BOOKMARK',
    'DISPID_SpeechPhraseReplacements', 'SVP_17', 'DISPID_SGRId',
    'DISPID_SGRSTransitions', 'DISPID_SVEVoiceChange',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SRSNumberOfActiveRules',
    'SITooLoud', 'SPEI_VOICE_CHANGE', 'DISPID_SpeechLexicon',
    'ISpeechGrammarRules', 'SpInprocRecognizer',
    'Speech_Max_Word_Length', 'SSTTDictation', 'DISPID_SVEBookmark',
    'DISPID_SPIAudioSizeTime', 'DISPID_SBSRead',
    'ISpeechObjectTokens', 'DISPID_SOTCGetDataKey',
    'SpeechRegistryUserRoot', 'SDTAudio', 'DISPID_SPAPhraseInfo',
    'DISPID_SLWs_NewEnum', 'DISPID_SRCEAdaptation', 'SPPS_RESERVED4',
    'SRERequestUI', 'SP_VISEME_2', 'ISpeechPhraseElement',
    'DISPID_SLPLangId', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SpeechMMSysAudio', 'SVP_10', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SRCResume', 'DISPID_SVSInputSentencePosition',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SAFGuid',
    'DISPID_SPRuleChildren', 'SPSTREAMFORMATTYPE',
    'SPPS_SuppressWord', 'SpeechSpecialTransitionType',
    'DISPID_SGRsCommit', 'SPXRO_Alternates_SML', 'ISpeechRecoResult2',
    'DISPID_SRGDictationSetState', 'DISPID_SPRDisplayAttributes',
    'SpeechAllElements', 'SAFT32kHz16BitMono',
    'DISPID_SPANumberOfElementsInResult', 'SPLEXICONTYPE',
    'ISpeechRecoGrammar', 'SRARoot',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SVSLastBookmark',
    'SP_VISEME_4', 'SP_VISEME_11', 'DISPID_SDKEnumValues',
    'SGSExclusive', 'SVP_15', 'DISPID_SGRsCount',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SDKGetlongValue',
    'STSF_LocalAppData', 'SPCONTEXTSTATE', 'SVP_12',
    'SPSSuppressWord', 'DISPID_SRCBookmark', 'ISequentialStream',
    'DISPID_SPPs_NewEnum', 'SAFTADPCM_8kHzStereo',
    'DISPID_SpeechPhraseBuilder', 'STCRemoteServer', 'SpeechRunState',
    'UINT_PTR', 'DISPID_SVSLastStreamNumberQueued', 'IEnumString',
    'SPSMF_UPS', 'DISPID_SpeechAudioBufferInfo', 'SSFMOpenForRead',
    'SAFTADPCM_8kHzMono', 'SAFT44kHz8BitStereo', 'SPRST_INACTIVE',
    'DISPID_SPRuleFirstElement', 'DISPIDSPRG', 'SREPrivate',
    'SP_VISEME_19', 'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SLWLangId',
    'SBONone', 'DISPID_SRGCmdLoadFromMemory', 'SVSFParseMask',
    'SWPKnownWordPronounceable', 'DISPID_SPCLangId',
    'DISPID_SPPChildren', 'SPFM_OPEN_READWRITE', 'SPVPRI_NORMAL',
    'DISPID_SpeechPhraseProperties', 'DISPID_SCSBaseStream',
    'DISPID_SVResume', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SpeechCustomStream', 'eLEXTYPE_RESERVED9',
    'SPEI_RESERVED3', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SRCEEnginePrivate', 'ISpeechWaveFormatEx',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SOTCDefault',
    'SREStreamStart', 'DISPID_SPELexicalForm', 'SVP_2',
    'SAFTCCITT_uLaw_44kHzMono', 'SVP_7', 'DISPID_SABIEventBias',
    'SpeechLexiconType', 'DISPID_SpeechDataKey', 'SPPS_Noun',
    'SPEI_MAX_TTS', 'DISPID_SRSAudioStatus', 'DISPID_SPPFirstElement',
    'SVESentenceBoundary', 'STCInprocHandler',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SDKDeleteValue',
    'DISPID_SPRs_NewEnum', 'SpeechAudioVolume',
    'DISPID_SRRAlternates', 'SPAO_NONE', 'DISPID_SRRSpeakAudio',
    'SGPronounciation', 'DISPID_SLPPhoneIds',
    'SPEI_SENTENCE_BOUNDARY', 'SRTSMLTimeout', 'DISPID_SGRName',
    'IInternetSecurityMgrSite', 'DISPID_SpeechLexiconPronunciation',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SPPsItem',
    'SpCustomStream', 'SREStreamEnd', 'SPPHRASEELEMENT',
    'DISPID_SLRemovePronunciation', 'SpeechCategoryAudioIn',
    'ISpeechPhraseReplacements', 'SRSEDone',
    'SpeechDictationTopicSpelling', 'SpStreamFormatConverter',
    'DISPID_SRCCreateResultFromMemory', 'SAFT48kHz16BitStereo',
    'SAFTADPCM_11kHzStereo', 'DISPID_SRAudioInputStream',
    'DISPID_SPAsCount', 'SPEI_RESERVED5', 'SVP_0', 'SVSFIsXML',
    'SPWF_INPUT', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SVEStreamStart', 'SVEStartInputStream',
    'ISpNotifyTranslator', 'SSTTWildcard', 'SPPS_RESERVED2',
    'DISPID_SGRSRule', 'SPAS_STOP', 'SAFT16kHz8BitStereo',
    'SRTReSent', 'SAFT32kHz8BitStereo', 'SVEAllEvents',
    'SPEI_REQUEST_UI', 'DISPID_SOTDataKey',
    'DISPID_SWFEAvgBytesPerSec', 'eLEXTYPE_PRIVATE18',
    'SpeechCategoryVoices', 'ISpRecognizer3', 'SPXRO_SML',
    'SVSFNLPMask', 'DISPID_SVStatus', 'SVP_4', 'DISPID_SPACommit',
    'SpTextSelectionInformation', 'DISPID_SPEsItem',
    'DISPID_SPRuleName', 'SPAUDIOOPTIONS', 'SPFM_OPEN_READONLY',
    'DISPID_SPIEngineId', 'SpAudioFormat', 'tagSPPROPERTYINFO',
    'DISPID_SVSLastBookmarkId', 'SpeechPropertyResourceUsage',
    'SVP_18', 'SPEI_RESERVED1', 'DISPID_SOTIsUISupported',
    'IEnumSpObjectTokens', 'eLEXTYPE_PRIVATE5',
    'SAFTCCITT_uLaw_11kHzMono', 'eLEXTYPE_PRIVATE6', 'SITooSlow',
    'DISPID_SRDisplayUI', 'SPEI_ADAPTATION', 'SAFT16kHz16BitStereo',
    'ISpResourceManager', 'SRESoundEnd', 'SDTReplacement',
    'SPPS_Unknown', 'DISPID_SVSPhonemeId', 'DISPID_SGRsDynamic',
    'DISPID_SRRDiscardResultInfo', 'SP_VISEME_0',
    'DISPID_SDKEnumKeys', 'SPSHORTCUTPAIR', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SpeechObjectToken', 'SSSPTRelativeToStart',
    'SGDSInactive', 'SPAO_RETAIN_AUDIO',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SPIRule',
    'ISpeechGrammarRuleState', 'SAFTCCITT_uLaw_8kHzMono',
    'ISpRecoResult', 'SSFMCreateForWrite', 'SPSHT_OTHER',
    'DISPID_SpeechPhoneConverter', 'eLEXTYPE_PRIVATE11',
    'SAFT12kHz8BitMono', 'DISPID_SGRInitialState', 'SRSInactive',
    'ISpeechPhraseElements', 'DISPID_SRSetPropertyNumber',
    'DISPID_SPRules_NewEnum', 'DISPID_SPPParent', 'DISPID_SGRSTRule',
    'DISPID_SPISaveToMemory', 'SPSModifier', 'SPEI_TTS_PRIVATE',
    'SVP_3', 'SPXMLRESULTOPTIONS', 'SPSInterjection',
    'eLEXTYPE_PRIVATE1', 'DISPID_SASState', 'SPWF_SRENGINE',
    'DISPID_SRCAudioInInterferenceStatus', 'SPEI_WORD_BOUNDARY',
    'DISPID_SGRSTPropertyValue', 'SpPhraseInfoBuilder',
    'SGDSActiveWithAutoPause', 'SPSFunction',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SLGetPronunciations',
    'ISpeechAudio', 'SPADAPTATIONRELEVANCE', 'SpeechTokenShellFolder',
    'eLEXTYPE_APP', 'DISPID_SpeechRecognizerStatus',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPVOICESTATUS',
    'ISpeechBaseStream', 'DISPID_SOTsCount', 'DISPID_SGRSTsItem',
    'SLODynamic', 'SAFT32kHz8BitMono', 'ISpAudio',
    'SAFT12kHz16BitStereo', 'DISPID_SpeechPhraseAlternates',
    'eWORDTYPE_DELETED', 'SVEEndInputStream', 'DISPID_SRRTStreamTime',
    'DISPID_SRRGetXMLResult', 'DISPID_SLGetGenerationChange',
    'SWPUnknownWordPronounceable', 'SWTDeleted', 'SGSEnabled',
    'SPFILEMODE', 'DISPID_SGRsAdd', 'SPAS_PAUSE', 'SPFM_NUM_MODES',
    'SAFTGSM610_8kHzMono', 'SpObjectToken', 'eLEXTYPE_RESERVED6',
    'DISPID_SpeechLexiconProns', 'SPFM_CREATE_ALWAYS',
    'SpNotifyTranslator', 'SPRST_NUM_STATES', 'DISPID_SRCEEndStream',
    'DISPID_SOTCEnumerateTokens', 'SPWORDTYPE',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SRCERequestUI',
    'SPEI_START_SR_STREAM', 'DISPID_SOTGetAttribute',
    'DISPID_SpeechAudioFormat', 'SPSUnknown', 'ISpeechResourceLoader',
    'DISPID_SGRSTPropertyName', 'SPINTERFERENCE_TOOQUIET',
    'SAFTCCITT_uLaw_22kHzStereo', 'SpeechRecognitionType',
    'DISPID_SGRsCommitAndSave', 'SpeechVisemeFeature',
    'DISPID_SRGCmdSetRuleIdState', 'SDTAlternates',
    'SpeechFormatType', 'SPPARTOFSPEECH', 'SAFT8kHz8BitStereo',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SFSOpen',
    'DISPID_SGRs_NewEnum', 'SBOPause', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SFSClose', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SpeechWaveFormatEx', '_ISpeechRecoContextEvents',
    'DISPID_SOTDisplayUI', 'tagSTATSTG', 'SpeechGrammarState',
    'DISPID_SRGIsPronounceable', 'DISPID_SpeechVoice',
    'DISPID_SAFSetWaveFormatEx', 'SpeechRetainedAudioOptions',
    'DISPID_SVEViseme', 'SPCS_ENABLED', 'SPGS_EXCLUSIVE', 'SGDisplay',
    'SP_VISEME_17', 'SPRECOGNIZERSTATUS',
    'DISPID_SRGetPropertyString', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SMSSetData', 'DISPID_SABufferInfo', 'SPAUDIOSTATE',
    'STSF_AppData', 'SPRULESTATE', 'DISPID_SRGDictationLoad',
    '_ISpeechVoiceEvents', 'DISPID_SPERetainedSizeBytes',
    'ISpRecoContext2', 'ISpMMSysAudio', 'DISPID_SDKSetStringValue',
    'SRSActiveAlways', 'SpeechTokenContext', 'ISpXMLRecoResult',
    'SDKLLocalMachine', 'SpeechLoadOption', 'ISpeechAudioBufferInfo',
    'DISPID_SREmulateRecognition', 'SAFT16kHz8BitMono',
    'DISPID_SpeechPhraseInfo', 'SpeechGrammarTagUnlimitedDictation',
    'ISpVoice', 'DISPID_SVSRunningState', 'SpeechRecognizerState',
    'DISPID_SPIRetainedSizeBytes', 'SECHighConfidence',
    'ISpeechRecoResultDispatch', 'DISPID_SPIReplacements',
    'SP_VISEME_8', 'SPSHORTCUTPAIRLIST', 'SpeechWordType',
    'Speech_StreamPos_RealTime', 'SPSHT_NotOverriden', 'SPGS_ENABLED',
    'SVP_5', 'SPSMF_SRGS_SAPIPROPERTIES', 'SREPropertyNumChange',
    'SVEAudioLevel', 'SREInterference', 'DISPID_SRCEPhraseStart',
    'DISPID_SpeechVoiceEvent', 'SAFT48kHz16BitMono', 'IStream',
    'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpeechCategoryRecoProfiles', 'SpeechEmulationCompareFlags',
    'ISpeechRecoResultTimes', 'eLEXTYPE_VENDORLEXICON',
    'SPTEXTSELECTIONINFO', 'SGRSTTWord',
    'DISPID_SpeechPhraseProperty', 'SpPhoneConverter',
    'DISPID_SRRAudioFormat', 'SRSEIsSpeaking', 'eLEXTYPE_PRIVATE7',
    'DISPID_SLPsItem', 'DISPID_SpeechObjectTokens',
    'eLEXTYPE_PRIVATE13', 'ISpPhrase', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'ISpGrammarBuilder', 'SPBO_AHEAD', 'DISPID_SRCEStartStream',
    'DISPID_SRRPhraseInfo', 'DISPID_SOTRemoveStorageFileName',
    'SPINTERFERENCE_NOISE', 'SAFT24kHz16BitMono', 'SPEI_HYPOTHESIS',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SOTCSetId',
    'eLEXTYPE_RESERVED7', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SP_VISEME_14', 'SITooQuiet', 'SVP_14', 'eLEXTYPE_PRIVATE8',
    'SPDATAKEYLOCATION', 'SINoise', 'DISPID_SRGetRecognizers',
    'SpeechRuleState', 'DISPID_SVEPhoneme', 'SpeechUserTraining',
    'SVSFPurgeBeforeSpeak', 'SVF_None', 'SGLexicalNoSpecialChars',
    'SSFMOpenReadWrite', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SPPS_Verb', 'SGSDisabled', 'SAFTADPCM_22kHzStereo',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SPRulesItem',
    'SpeechDisplayAttributes', 'SAFT22kHz16BitStereo',
    'SVSFlagsAsync', 'SGDSActive', 'SP_VISEME_10', 'DISPID_SPPId',
    'ISpeechPhraseProperties', 'Speech_Max_Pron_Length',
    'SpeechDataKeyLocation', 'DISPID_SPPName',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SRGId', 'ISpRecoGrammar2',
    'SpeechAudioProperties', 'DISPID_SRCreateRecoContext',
    'DISPID_SPERequiredConfidence', 'DISPID_SRCRecognizer',
    'SpResourceManager', 'SVEPrivate', 'SGRSTTDictation',
    'ISpeechLexiconPronunciations', 'DISPID_SABIBufferSize',
    'SRADynamic', 'SPAR_High', 'DISPID_SRRSetTextFeedback',
    'DISPID_SOTCreateInstance', 'eLEXTYPE_PRIVATE10',
    'SpInProcRecoContext', 'DISPID_SRCRetainedAudio',
    'DISPID_SLWsItem', 'SASRun', 'DISPID_SRCERecognition',
    'SPINTERFERENCE_TOOSLOW', 'SpeechMicTraining',
    'DISPID_SLRemovePronunciationByPhoneIds', 'Speech_Default_Weight',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'ISpPhoneConverter',
    'SDTRule', 'SPSERIALIZEDPHRASE', 'SGRSTTWildcard', 'SP_VISEME_7',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SOTs_NewEnum',
    'DISPID_SABIMinNotification', 'ISpeechPhraseRule',
    'SpMemoryStream', 'ISpeechPhraseAlternate', 'SPEVENTSOURCEINFO',
    'DISPID_SRCEHypothesis', 'ISpObjectWithToken',
    'DISPID_SWFEExtraData', 'eLEXTYPE_PRIVATE3', 'DISPID_SOTCategory',
    'SPEI_SR_BOOKMARK', 'SPEI_MIN_SR', 'DISPID_SPIEnginePrivateData',
    'SpPhoneticAlphabetConverter', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SPRuleEngineConfidence',
    'SPEVENT', 'ISpShortcut', 'SPRECOCONTEXTSTATUS',
    'DISPID_SPRuleId', 'ISpPhraseAlt', 'DISPID_SPPValue',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SRRAudio',
    'DISPID_SGRSTText', 'SECFEmulateResult', 'DISPID_SLWType',
    'DISPID_SRIsShared', 'SPBOOKMARKOPTIONS',
    'DISPID_SRGDictationUnload', 'DISPID_SGRSTNextState',
    'ISpLexicon', 'DISPID_SPPsCount', 'eLEXTYPE_PRIVATE4',
    'SPSHORTCUTTYPE', 'DISPID_SVVolume', 'DISPIDSPTSI_ActiveLength',
    'SPEI_RECO_STATE_CHANGE', 'SRAImport', 'SVSFUnusedFlags',
    'DISPID_SpeechAudioStatus', 'DISPID_SVDisplayUI',
    'ISpeechPhraseProperty', 'SpeechStreamFileMode',
    'DISPID_SGRSTWeight', 'SVPAlert', 'SPRULE',
    'SPINTERFERENCE_LATENCY_WARNING', 'ISpeechAudioFormat',
    'SRCS_Disabled', 'SPDKL_DefaultLocation', 'DISPID_SGRsFindRule',
    'ISpProperties', 'DISPID_SMSGetData', 'SAFT44kHz16BitMono',
    'ISpeechLexiconWords', 'SpeechPropertyComplexResponseSpeed',
    'SVSFParseAutodetect', 'SPWORDPRONUNCIATION', 'DISPID_SRCVoice',
    'DISPID_SVSVisemeId', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SDKDeleteKey', 'SPAS_RUN', 'SPPS_Noncontent',
    'DISPID_SVIsUISupported', 'SP_VISEME_1', 'SPPS_Function',
    'SPRECOSTATE', 'SPWORDPRONOUNCEABLE', 'DISPID_SPAsItem',
    'DISPID_SLPType', 'SAFTADPCM_44kHzMono', 'SRERecognition',
    'DISPID_SRGRules', 'SRADefaultToActive', 'DISPID_SPIProperties',
    'SVP_16', 'ISpeechVoiceStatus', 'ISpRecoCategory',
    'SPCS_DISABLED', 'DISPID_SVSpeakStream', 'DISPID_SVEWord',
    'SVP_21', 'DISPIDSPTSI_ActiveOffset', 'SPEI_SOUND_END',
    'SPDKL_LocalMachine', 'eLEXTYPE_PRIVATE17', 'SREHypothesis',
    'SP_VISEME_3', 'SP_VISEME_5', 'SP_VISEME_21',
    'eLEXTYPE_PRIVATE16', 'DISPID_SPRuleParent',
    'DISPID_SpeechFileStream', 'SPPHRASEPROPERTY', 'SVP_13',
    'DISPIDSPTSI', 'SSSPTRelativeToEnd', 'DISPID_SVAudioOutputStream',
    'DISPID_SVEEnginePrivate', 'SPEI_RECOGNITION',
    'SPPS_NotOverriden', 'DISPID_SRSCurrentStreamPosition',
    'SpShortcut', 'DISPID_SPAStartElementInResult',
    'DISPID_SpeechVoiceStatus', 'DISPID_SPRText',
    'ISpObjectTokenCategory', 'DISPID_SpeechPhraseReplacement',
    'SpeechCategoryRecognizers', 'SAFTADPCM_44kHzStereo',
    'ISpeechRecoContext', 'DISPID_SPILanguageId', 'ISpeechLexicon',
    'SDTPronunciation', 'SSFMCreate', 'DISPID_SRProfile',
    'ISpeechLexiconPronunciation', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SpeechPhraseElements',
    'DISPID_SRCERecognitionForOtherContext', 'SPEVENTENUM', 'SINone',
    'DISPID_SpeechGrammarRules', 'SpeechCategoryAudioOut',
    'SAFT11kHz8BitStereo', 'SPWORD', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SAFTCCITT_uLaw_22kHzMono', 'eLEXTYPE_RESERVED4',
    'DISPID_SPEs_NewEnum', 'SAFTCCITT_ALaw_11kHzMono', 'SPSVerb',
    'SpeechPropertyResponseSpeed', 'SpeechTokenIdUserLexicon',
    'ISpeechRecognizer', 'SDTDisplayText', 'SVF_Stressed',
    'SAFT8kHz16BitMono', 'DISPID_SGRsItem', 'DISPID_SPEsCount',
    'SP_VISEME_20', 'SDKLCurrentConfig', 'SPWT_LEXICAL',
    'DISPID_SVPause', 'SPVPRIORITY', 'SVSFParseSapi',
    'ISpeechPhraseReplacement', 'DISPID_SRCRetainedAudioFormat',
    'SPVISEMES', 'DISPID_SRGState', 'SPINTERFERENCE',
    'SDA_Two_Trailing_Spaces', 'DISPID_SVPriority', 'SRTStandard',
    'DISPID_SPEPronunciation', 'ISpeechFileStream', 'DISPID_SRStatus',
    'SVSFParseSsml', 'SpeechAudioState', 'SRAORetainAudio',
    'SAFT16kHz16BitMono', 'SLTUser', 'SPAUDIOBUFFERINFO',
    'SPCT_SLEEP', 'SPRECORESULTTIMES', 'SVSFVoiceMask',
    'SWPUnknownWordUnpronounceable', 'DISPID_SVSpeak',
    'SECNormalConfidence', 'ISpEventSource', 'SPWT_DISPLAY',
    'SECFNoSpecialChars', 'SDA_No_Trailing_Space', 'SVP_11',
    'SAFTText', 'SAFTCCITT_ALaw_11kHzStereo', 'SPWORDLIST',
    'DISPID_SpeechPhraseRules', 'DISPID_SOTGetDescription',
    'DISPID_SDKGetStringValue', 'DISPID_SOTMatchesAttributes',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SVWaitUntilDone',
    'SGRSTTTextBuffer', 'ISpeechXMLRecoResult', 'SP_VISEME_9',
    'SpMMAudioEnum', 'SRTAutopause', 'DISPID_SRCRequestedUIType',
    'SAFT44kHz16BitStereo', 'DISPID_SRGRecoContext',
    'DISPID_SLPSymbolic', 'SPPHRASERULE', 'SPSNoun',
    'DISPID_SRSCurrentStreamNumber', 'SRTExtendableParse',
    'SAFTADPCM_22kHzMono', 'DISPID_SpeechLexiconWord', 'DISPID_SOTId',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SPEDisplayAttributes',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SRCVoicePurgeEvent',
    'WAVEFORMATEX', 'STCInprocServer', 'SVSFDefault', 'SPAS_CLOSED',
    'SAFTCCITT_ALaw_44kHzStereo', 'SVEWordBoundary',
    'DISPID_SPEAudioTimeOffset', 'SVSFIsFilename', 'DISPID_SRCPause',
    'DISPID_SRRSaveToMemory', 'SREPropertyStringChange',
    'SpNullPhoneConverter', 'eLEXTYPE_PRIVATE15',
    ...
    'ISpeechGrammarRuleStateTransitions', 'eLEXTYPE_PRIVATE9',
    'DISPID_SLPsCount', 'DISPID_SDKOpenKey',
    'DISPID_SGRSAddWordTransition', 'DISPID_SPRFirstElement',
    'DISPID_SBSSeek', 'SpeechAddRemoveWord', 'SPEI_SR_AUDIO_LEVEL',
    'eLEXTYPE_RESERVED10', 'SpeechEngineProperties',
    'SAFTCCITT_ALaw_8kHzMono', 'SP_VISEME_16',
    'SpeechGrammarRuleStateTransitionType', 'SAFTGSM610_11kHzMono',
    'SVEPhoneme', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPCT_SUB_COMMAND', 'DISPID_SVSInputSentenceLength',
    'SAFT12kHz16BitMono', 'SAFT22kHz8BitMono', 'DISPID_SRCState',
    'DISPID_SPIGrammarId', 'SAFT8kHz16BitStereo', 'SGRSTTRule',
    'DISPID_SpeechPhraseRule', 'SPBO_TIME_UNITS',
    'DISPID_SVAlertBoundary', 'SAFT44kHz8BitMono',
    'eLEXTYPE_LETTERTOSOUND', 'SpeechAudioFormatGUIDWave',
    'SPCT_SUB_DICTATION', 'SPEI_PROPERTY_NUM_CHANGE', 'SpMMAudioOut',
    'SITooFast', 'ISpPhoneticAlphabetSelection',
    'DISPID_SWFEChannels', 'DISPID_SVSInputWordPosition',
    'DISPID_SVGetVoices', 'SVPOver', 'SP_VISEME_6', 'DISPID_SOTCId',
    'SINoSignal', 'DISPID_SpeechPhraseAlternate',
